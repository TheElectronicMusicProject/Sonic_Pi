...
# vibrato_rate: number of wobbles per second (default 6)
# vibrato_depth: amount of variation around the central note (default 0.15)
# vibrato_delay: amount of seconds before the vibrato kicks in (default 0.5) [can't be changed once set]
# vibrato_onset: amount of seconds before the vibrato reaches the full power (default 0.1) [can't be changed once set]
...
use_synth :blade
play note: :c3, amp: amp, pan: pan, attack: attack, decay: decay, sustain: sustain, release: release, attack_level: attack_level, decay_level: decay_level, sustain_level: sustain_level, env_curve: env_curve, cutoff: cutoff, vibrato_rate: vibrato_rate, vibrato_depth: vibrato_depth, vibrato_delay: vibrato_delay, vibrato_onset: vibrato_onset