...
live_loop :melodia do
  with_fx :reverb, mix: 0.4 do
    ...
    use_synth :saw
    play_pattern_timed chord(:C3, :minor7), 0.25, pan: rrand(-1, 1), release: 0.05
    play_pattern_timed chord(:C4, :minor7), 0.25, pan: rrand(-1, 1), release: 0.1
    play_pattern_timed chord(:C5, :minor7), 0.25, pan: rrand(-1, 1), release: 0.2
    play_pattern_timed chord(:C6, :minor7), 0.25, pan: rrand(-1, 1), release: 0.3
  end
end
