...
# Needed to use the rate inside control
use_arg_checks false

with_fx :nrlpf, mix: 0.5, res: 0.4, cutoff: 60, cutoff_slide: 4, mix_slide: 4 do |dc|
  with_fx :bitcrusher, mix: 0.2, sample_rate: 1000, sample_rate_slide: 4, mix_slide: 4 do |bc|
    ...
    sample :loop_amen, rate: 1.0, start: 0.25, finsih: 0.35, beat_stretch: 4
    sleep 0.25
    sample :loop_amen, rate: 1.05, start: 0.25, finsih: 0.35, beat_stretch: 4
    sleep 0.25
    sample :loop_amen, rate: 1.1, start: 0.25, finsih: 0.35, beat_stretch: 4
    sleep 0.25
    sample :loop_amen, rate: 1.15, start: 0.25, finsih: 0.35, beat_stretch: 4
    sleep 0.25
    sample :loop_amen, rate: 1.20, start: 0.25, finsih: 0.35, beat_stretch: 4
    sleep 0.25
    sample :loop_amen, rate: 1.25, start: 0.25, finsih: 0.35, beat_stretch: 4
    sleep 0.25
    sample :loop_amen, rate: 1.3, start: 0.25, finsih: 0.35, beat_stretch: 4
    sleep 0.25
    sample :loop_amen, rate: 1.35, start: 0.25, finsih: 0.35, beat_stretch: 4
    sleep 0.25
    sample :loop_amen, rate: 1.65, start: 0, finsih: 0.15, beat_stretch: 4
    sleep 0.5
    sample :loop_amen, rate: 1.25, start: 0, finsih: 0.25, beat_stretch: 4
    sleep 0.5
    sample :loop_amen, rate: 1, start: 0.75, finsih: 0.875, beat_stretch: 4
    sleep 0.5
    sample :loop_amen, rate: 1, start: 0.75, finsih: 0.875, beat_stretch: 4
    sleep 0.5
